...
// AMQP tests.
//
TEST_FUNCTION(IotHub_AMQP_Modules_SendReported_e2e_sas)
{
    dt_e2e_send_reported_test(AMQP_Protocol, IOTHUB_ACCOUNT_AUTH_CONNSTRING);
}

TEST_FUNCTION(IotHub_AMQP_Modules_GetFullDesired_e2e_sas)
{
...
// AMQP_WS tests.
//
TEST_FUNCTION(IotHub_AMQP_Modules_WS_SendReported_e2e_sas)
{
    dt_e2e_send_reported_test(AMQP_Protocol_over_WebSocketsTls, IOTHUB_ACCOUNT_AUTH_CONNSTRING);
}

TEST_FUNCTION(IotHub_AMQP_Modules_WS_GetFullDesired_e2e_sas)
{
